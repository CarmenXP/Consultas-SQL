...
--Ejercicio 2
select accounts.account_no, accounts.client_id, transactions_types.name from accounts left join transactions_types on accounts.type = transactions_types.id;              
--Ejercicio 3
select transactions.id, transactions.amount,transactions_types.name from transactions left join transactions_types on transactions.transaction_type  = transactions_types.id; 
--Ejercicio 4
...
--View2
create view v_accounts_types as select accounts.account_no, accounts.client_id, transactions_types.name from accounts left join transactions_types on accounts.type = transactions_types.id; 
--View3
